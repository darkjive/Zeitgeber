...
const de: Dict = {
  ...
  'kids.q.sunset': 'Wann geht die Sonne heute unter?',
  'kids.a.sunset': 'Heute um {time} Uhr.',
  'kids.a.sunsetNone': 'Heute geht sie gar nicht unter – so weit oben oder unten auf der Erde bleibt es manchmal tagelang hell.',
  'kids.exp.sunset': 'Die Erde dreht sich einmal am Tag um sich selbst. Deshalb geht die Sonne jeden Tag auf und wieder unter.',
  'kids.q.sky': 'Warum ist der Himmel blau?',
  'kids.a.skyBlue': 'Genau – schau mal hoch, jetzt gerade ist er blau!',
  'kids.a.skyDark': 'Gerade ist es dunkel. Aber tagsüber ist der Himmel blau.',
  'kids.exp.sky': 'Sonnenlicht sieht weiß aus, besteht aber aus vielen Farben. Blaues Licht wird von der Luft am stärksten in alle Richtungen gestreut – deshalb sehen wir überall am Himmel Blau.',
  'kids.q.sameSize': 'Warum sehen Sonne und Mond am Himmel gleich groß aus?',
  'kids.a.sameSize': 'Reiner Zufall! Die Sonne ist viel größer, aber auch viel weiter weg.',
  'kids.exp.sameSize': 'Die Sonne ist etwa 400-mal so groß wie der Mond – aber auch etwa 400-mal so weit entfernt. Deshalb gleicht sich das am Himmel genau aus.',
  'kids.q.sleep': 'Warum werden wir abends müde?',
  'kids.a.sleepDay': 'Jetzt ist es hell – da sagt dir dein Körper meistens: wach bleiben!',
  'kids.a.sleepNight': 'Jetzt ist es dunkel – da schüttet dein Körper einen Müde-Stoff aus.',
  'kids.exp.sleep': 'In dir tickt eine innere Uhr. Wenn es dunkel wird, schüttet dein Körper den Stoff Melatonin aus – der macht müde und hilft beim Einschlafen.',
  ...
  'dial.solarNoon': 'Sonnenhöchststand um {time}',
  'dial.legalNoon': 'Gesetzlicher Mittag, 12:00',
  ...
  'dial.hourHand': 'Stundenzeiger',
  'dial.minuteHand': 'Minutenzeiger',
  'dial.secondHand': 'Sekundenzeiger',
  'dial.sleepWindow': 'Ideales Schlaffenster (persönlicher Rhythmus)',
  ...
  'onboard.profile.title': 'Was interessiert dich am meisten?',
  'onboard.profile.body': 'Wir schalten dir die passenden Module direkt frei — du kannst das jederzeit im Menü ändern.',
  'onboard.profile.outdoor': 'Outdoor-Abenteuer',
  'onboard.profile.space': 'Weltraum & Sterne',
  'onboard.profile.solar': 'Solarstrom',
  'onboard.profile.sleep': 'Schlaf & Rhythmus',
...
const en: Dict = {
  ...
  'kids.q.sunset': 'When does the sun set today?',
  'kids.a.sunset': 'Today at {time}.',
  'kids.a.sunsetNone': "Today it doesn't set at all – far up or down on Earth it can stay light for days at a time.",
  'kids.exp.sunset': 'The Earth spins around once a day. That’s why the sun rises and sets every single day.',
  'kids.q.sky': 'Why is the sky blue?',
  'kids.a.skyBlue': 'Exactly – look up, it’s blue right now!',
  'kids.a.skyDark': 'It’s dark right now. But during the day, the sky is blue.',
  'kids.exp.sky': 'Sunlight looks white, but it’s made of many colors. Blue light gets scattered in all directions by the air the most – that’s why we see blue everywhere in the sky.',
  'kids.q.sameSize': 'Why do the sun and moon look the same size in the sky?',
  'kids.a.sameSize': 'Pure coincidence! The sun is much bigger, but also much farther away.',
  'kids.exp.sameSize': 'The sun is about 400 times bigger than the moon – but also about 400 times farther away. That balances out exactly in the sky.',
  'kids.q.sleep': 'Why do we get sleepy in the evening?',
  'kids.a.sleepDay': "It's light out right now – your body usually says: stay awake!",
  'kids.a.sleepNight': "It's dark right now – your body releases a sleepy substance.",
  'kids.exp.sleep': 'You have an inner clock inside you. When it gets dark, your body releases melatonin – it makes you sleepy and helps you fall asleep.',
  ...
  'dial.solarNoon': 'Solar noon at {time}',
  'dial.legalNoon': 'Legal noon, 12:00',
  ...
  'dial.hourHand': 'Hour hand',
  'dial.minuteHand': 'Minute hand',
  'dial.secondHand': 'Second hand',
  'dial.sleepWindow': 'Ideal sleep window (personal rhythm)',
  ...
  'onboard.profile.title': 'What interests you most?',
  'onboard.profile.body': 'We switch on the matching modules right away — you can change this any time in the menu.',
  'onboard.profile.outdoor': 'Outdoor adventures',
  'onboard.profile.space': 'Space & stars',
  'onboard.profile.solar': 'Solar power',
  'onboard.profile.sleep': 'Sleep & rhythm',
